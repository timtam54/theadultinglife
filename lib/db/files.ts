...
export async function listFiles(
  ...
  opts?: {
    ...
    search?: string;
    /** When true, hide files whose instance_id is set. Used by the folder
     *  Documents view — files attached to a specific page-form entry
     *  belong to that entry, not the folder pile. */
  ...
  if (opts?.excludeEntryFiles) q = q.is("instance_id", null);
