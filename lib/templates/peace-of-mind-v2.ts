...
export const PLANNER_SECTIONS: readonly PlannerSection[] = [
  ...
  },
  {
    ...
    hint: "Contact details for family — shared with your family group.",
    kind: "planner-only",
    plannerEditor: "letters",
    group: "Important Consultants & Contacts",
  },
  ...
  // Device Access Details
  {
    ...
    hint: "Phones, tablets, computers — PINs and access info.",
    kind: "planner-only",
    plannerEditor: "letters",
  ...
  // Important Documents
  {
    ...
    hint: "Uploaded documents ticked for inclusion in the Planner.",
    kind: "planner-only",
    plannerEditor: "letters",
  ...
  // Will
  {
    ...
    hint: "Where the original is stored, executor contact, first-steps notes.",
    kind: "planner-only",
    plannerEditor: "will-meta",
    group: "Will",
  },
